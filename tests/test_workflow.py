...
class WorkflowTests(unittest.TestCase):
    def setUp(self):
        ...
        values = patch(
            "app.ai_triage.dotenv_values",
            return_value={
                "OPENAI_API_KEY": "test-key-must-never-be-exposed",
    ...
    def test_offline_workflow_through_approval_and_audit(self):
        ...
        response = self.client.post(
            f"/maintenance/{maintenance_id}/triage"
        )
    ...
    def test_openai_requires_key_and_reports_configuration_only(
        self,
    ):
        maintenance_id = self.create_request()
